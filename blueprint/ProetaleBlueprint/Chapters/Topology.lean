...
:::corollary "cor:affproet-sheafification-commute" (parent := "proetale-topology") (uses := "def:affproet-site") (lean := "AlgebraicGeometry.Scheme.ProEt.sheafPullbackCompIso")
...
:::proposition "prop:proet-wc" (parent := "proetale-topology") (uses := "def:weakly-contractible, def:proetale-site") (lean := "AlgebraicGeometry.Scheme.AffineProEt.exists_isWeaklyContractible_cover")
...
:::lemma_ "lemma:affproet-relatively-pro-prepresentable" (parent := "proetale-topology") (uses := "def:one-cover-relatively-pro-prepresentable") (lean := "AlgebraicGeometry.Scheme.AffineProEt.minimalPrecoverage_le_relativelyPresentable")
...
:::corollary "lemma:pullback-section-affproet" (parent := "proetale-topology") (uses := "lemma:forget-proet-continuous, def:affproet") (lean := "AlgebraicGeometry.Scheme.ProEt.isColimitSheafPullbackSectionsCocone")
...
:::lemma_ "lemma:derived-pullback-section-affproet" (parent := "proetale-topology") (uses := "lemma:forget-proet-continuous") (lean := "AlgebraicGeometry.Scheme.ProEt.mapExt_bijective_sheafPullback")
...
:::corollary "cor:derived-sections-proetale-etale-iso" (parent := "proetale-topology") (uses := "lemma:forget-proet-continuous") (lean := "AlgebraicGeometry.Scheme.ProEt.sheafHAddEquiv")
...
:::definition "def:continuous-etale-cohomology" (parent := "proetale-topology") (lean := "AlgebraicGeometry.Scheme.continuousH")
Denote by
...
:::theorem "thm:comparison-continuous" (parent := "proetale-topology") (uses := "def:continuous-etale-cohomology, lemma:forget-proet-continuous") (lean := "AlgebraicGeometry.Scheme.ProEt.nonempty_continuousH_addEquiv_H_limit")
