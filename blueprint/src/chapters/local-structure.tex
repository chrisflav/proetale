...
\begin{lemma}[{\cite[\href{https://stacks.math.columbia.edu/tag/04PL}{Tag 04PL}]{stacks-project}}]
  ...
  \lean{isClosed_and_iUnion_connectedComponent_iff}
  \leanok
  Let $X$ be a topological space. Assume $X$ is quasi-compact, quasi-separated
...
\begin{lemma}
  ...
  \lean{T0Space.pullback,PrespectralSpace.pullback,SpectralSpace.pullback,QuasiSeparatedSpace.pullback,QuasiSober.pullback,QuasiCompactSpace.pullback}
  \leanok
...
\end{tikzcd}
\]
be a cartesian diagram in the category of topological spaces with $T$ profinite. Then $T = \pi_0(Y)$.
