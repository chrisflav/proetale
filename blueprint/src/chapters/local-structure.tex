...
\begin{lemma}
  ...
  \lean{Topology.IsClosedEmbedding.quasiSeparatedSpace,Topology.IsClosedEmbedding.spectral,Spectral.of_isClosed}
  \leanok
...
\begin{proof}
  \uses{thm:spectral-product,thm:closed-subspace-spectral}
  Note that \(X \times_S Y\) is a closed subspace of $X \times Y$. (See \verb`TopCat.pullbackIsoProdSubtype`.) Since $X \times Y$ is spectral (\Cref{thm:spectral-product}) it follows that \(X \times_S Y\) is spectral (\Cref{thm:closed-subspace-spectral}).
\end{proof}
