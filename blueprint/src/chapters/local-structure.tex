...
% Translate Henselization into some tensor product
...
\begin{lemma}[{\cite[Lemma 2.1.4, second part]{proetale}}]
    ...
    \uses{def:w-local-space}
    \lean{WLocalSpace.closedPointsHomeomorph}
...
\begin{lemma}[{\cite[Lemma 2.2.9]{proetale}}]
    ...
    \uses{def:w-strictly-local-ring,def:w-local-ring,def:strictly-henselian-local-ring}
    \lean{WStrictlyLocalRing.isStrictlyHenselianLocalRing_of_isMaximal,wStrictlyLocalRing_of_isStrictlyHenselianLocalRing_atPrime}
...
\begin{lemma}[{\cite[Theorem 2.4.9]{proetale}}, {\cite[\href{https://stacks.math.columbia.edu/tag/0983}{Tag 0983}]{stacks-project}}]
