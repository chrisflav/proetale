...
\begin{lemma}
  ...
  \uses{def:ind-Zariski}
  \lean{Algebra.IndZariski.of_colimitPresentation,RingHom.IndZariski.iff_exists_indZariski,
...
\begin{lemma}
  ...
  \uses{def:ind-Zariski}
  \lean{Algebra.IndZariski.prod,RingHom.IndZariski.prod}
  \leanok
\end{lemma}
...
\begin{lemma}
    ...
    \lean{Algebra.IndEtale.of_colimitPresentation,RingHom.IndEtale.iff_ind_indEtale,
      RingHom.IndEtale.iff_exists_indEtale,Algebra.IndEtale.iff_ind_indEtale}
    \leanok
\end{lemma}
