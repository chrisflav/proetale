...
\begin{definition}
    ...
    \lean{WLocalization.prodStrata, WLocalization.prodStrataIdeal}
    \leanok
\end{definition}
...
\begin{lemma}
    ...
    \lean{WLocalization.exists_specializes_zeroLocus_prodStrataIdeal, WLocalization.mem_zeroLocus_prodStrataIdeal_of_isClosed}
    \leanok
\end{lemma}
...
\begin{proof}
  ...
  \uses{thm:extremally-disconnected-cover,def:modify-pi0-profinite,thm:modify-pi0-profinite-properties,thm:cartesian-profinite-w-local,thm:ind-Zariski-identifies-local-rings,thm:w-contractible-if}
  ...
  By \Cref{thm:modify-pi0-profinite-properties}, \Cref{def:modify-pi0-profinite} gives an ind-Zariski ring map $C \to D$ such that $\pi_0(\Spec (D)) \to \pi_0(\Spec (C))$ realizes $T \to \pi_0(\Spec (C))$ and such that
  \[
  \begin{tikzcd}
