...
\begin{proposition}[{\cite[Proposition 4.2.8]{proetale}}]
    ...
    \label{prop:proet-wc}
    \lean{AlgebraicGeometry.Scheme.AffineProEt.exists_isWeaklyContractible_cover}
    \leanok
\end{proposition}
...
\begin{lemma}
    ...
    \lean{AlgebraicGeometry.Scheme.ProEt.preservesRelativeFilteredColimits_lan_toProEtale}
    \leanok
\end{lemma}
...
\begin{corollary}[{\cite[Lemma 5.1.1]{proetale}}]
    ...
    \lean{AlgebraicGeometry.Scheme.ProEt.isColimitSheafPullbackSectionsCocone}
    \leanok
\end{corollary}
...
\begin{lemma}[{\cite[Lemma 5.1.6]{proetale}}]
    ...
    \lean{AlgebraicGeometry.Scheme.ProEt.mapExt_bijective_sheafPullback}
    \leanok
\end{lemma}
...
\begin{corollary}
    ...
    \lean{AlgebraicGeometry.Scheme.ProEt.sheafHAddEquiv}
    \leanok
\end{corollary}
...
\begin{definition}[{\cite[\S3]{jannsen}}]
    ...
    \lean{AlgebraicGeometry.Scheme.continuousH}
    \leanok
\end{definition}
...
\begin{theorem}[{\cite[Proposition 5.6.2]{proetale}}]
    ...
    \lean{AlgebraicGeometry.Scheme.ProEt.nonempty_continuousH_addEquiv_H_limit}
    \leanok
\end{theorem}
