...
\begin{lemma}[{\cite[\href{https://stacks.math.columbia.edu/tag/0968}{Tag 0968}]{stacks-project}}]
    \label{lemma:w-local-open-cover-refinement}
    \uses{def:w-local-space}
...
\begin{lemma}[\stacksproject{0A31}]
    Let $X$ be a spectral space and $E \subseteq X$ a quasi-compact subset. Then
    $E^g$ is an intersection of quasi-compact open subsets.
...
\begin{lemma}
    ...
    \uses{def:w-local, def:generalization}
...
\begin{proof}
    \uses{lemma:finite-stratification-ideal-bijection, lemma:closure-limit}
