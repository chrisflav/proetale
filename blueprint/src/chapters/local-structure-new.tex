...
\begin{proof}
    \uses{lemma:w-localization-ind-Zariski, thm:ind-Zariski-identifies-local-rings,
      lemma:w-local-tilde-w-local,
      thm:isom-of-identifies-local-rings-bijective, lemma:preimage-closed-points-algebraic}
...
\begin{proof}
    \uses{prop:w-localization-closed-points, lemma:w-local-tilde-w-local}
