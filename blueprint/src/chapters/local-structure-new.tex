...
\begin{lemma}
    ...
    \label{lemma:spectral-constructible-open-iff}
    Let $X$ be a spectral space and $W \subseteq X$ a subset. Then
    $W$ is open (resp. closed) in the constructible topology if and only if
    it is a union (resp. intersection) of constructible subsets.
\end{lemma}
