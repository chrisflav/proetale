...
\begin{proof}
  \uses{def:colim-open-closed-localizations,thm:colim-open-closed-localizations-surj-ind-zariski,thm:finite-product-identifies-local-rings,thm:ind-Zariski-identifies-local-rings,thm:identifies-local-rings-composition,thm:identifies-local-ring-to-top-fully-faithful,thm:cartesian-w-local}
  ...
  \end{tikzcd}
  \]
  of topological spaces. By \Cref{thm:cartesian-w-local} we conclude that $T = \pi_0(Y)$.
\end{proof}
